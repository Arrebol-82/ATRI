...
import ThanksWatchingSection from '~/components/site/ThanksWatchingSection.vue'
  ...
  <main class="home-page-root min-h-screen overflow-x-hidden bg-white text-[#102a3a]">
    ...
    >
      ...
      <aside class="relative z-10 flex h-screen w-full flex-col border-l border-[rgba(120,180,210,0.28)] bg-white/95 px-6 pb-7 pt-[34px] shadow-[-18px_0_50px_rgba(80,130,160,0.08)] lg:w-[240px]">
        ...
        <div class="nav-lang-controller" aria-label="Language switcher">
          <span class="nav-lang-label">LANGUAGE</span>

          <div class="nav-lang-buttons">
            <button
              v-for="item in languageOptions"
              :key="item.code"
              type="button"
              class="lang-switch-btn"
              :class="{ 'is-active': currentLang === item.code }"
...
.nav-lang-controller {
  ...
  box-shadow: 0 10px 26px rgba(80, 150, 200, 0.12);
...
.lang-switch-btn.is-active {
  color: #fff;
  background: linear-gradient(135deg, #70c5ff, #9bdcff);
  box-shadow: 0 6px 16px rgba(80, 160, 220, 0.28);
}
